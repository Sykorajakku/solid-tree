export default class TREE {
    private static readonly base = 'https://w3id.org/tree#';
    public static view = this.base + 'view';
    public static viewDescription = this.base + 'viewDescription';
    public static node = this.base + 'node';
    public static Node = this.base + 'Node';
    public static Relation = this.base + 'Relation';
    public static relation = this.base + 'relation';
